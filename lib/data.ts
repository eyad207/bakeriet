  ...
  webPages: [
    {
      title: 'About Us',
      slug: 'about-us',
      content: `About Us | Bakeriet
Welcome to Bakeriet – Your Destination for Quality, Convenience, and Innovation.

At Bakeriet, we’re more than just an online store – we’re a trusted marketplace built with passion, precision, and a strong focus on customer satisfaction. Based in the heart of the UAE, our goal is to bring you a seamless shopping experience that combines quality products, competitive prices, and exceptional service.

🌍 Who We Are
Founded with the vision of redefining e-commerce in the Emirates and beyond, Bakeriet is your go-to platform for everything from daily essentials to luxury finds. We serve customers across the UAE and the region with a curated collection of top brands and unique items from trusted suppliers.
...
🤝 Join Our Journey
Whether you're shopping for yourself or for loved ones, Bakeriet is here to serve you with integrity, style, and care. We're constantly growing and evolving to meet your needs—thank you for being a part of our journey.
...
`,
    ...
    },
    {
      ...
      content: `At Bakeriet, we believe that excellent customer service is the foundation of a great shopping experience. Our team is committed to making sure you feel confident, supported, and satisfied every step of the way.
...
Email: support@bakeriet.ae (Replies within 24–48 hours)
...
If anything goes wrong with your experience, we’ll make it right. From quick replacements to full refunds, we stand behind every product we sell. Shopping with Bakeriet means shopping with confidence.
...
Contact our support team at returns@bakeriet.ae with your order number.
...
For more details, visit our Returns Center.`,
  ...
  carousels: [
    ...
    },
    {
      ...
      buttonCaption: 'View Menu',
      image: '/images/banner1.jpg',
      url: '/menu?category=breads',
      isPublished: true,
    },
    {
      title: 'Seasonal Chef Specials',
      buttonCaption: 'Discover More',
      image: '/images/banner2.jpg',
      url: '/menu?category=specials',
      isPublished: true,
    },
  ],
  settings: [
    {
      ...
      site: {
        name: 'Bakeriet',
        description:
          'Bakeriet is a platform that allows you to buy and sell products online.',
        keywords: 'Spend less, enjoy more',
        url: 'https://www.bakeriet.vercel.app',
        logo: '/icons/logo.svg',
